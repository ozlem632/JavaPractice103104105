...
public class C06_IfStatement {
    ...
    public static void main(String[] args) {
        // son basamagin o  olma ihtimali magilis 10 dur
...
//Kullanıcıdan 4 basamakli bir sayi girmesini isteyin.
        ...
        if (sayi < 1000 || sayi > 9999) { //istenmeyen durum incelendi
            ...
            if (sayi % 10 == 0) {//4 basamkli 5 ile bolunebilen son rak=0//%10 magilis 10 son basamagin o olup olmadigini kontrol eder
